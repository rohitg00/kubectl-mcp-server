...
def test_server_imports():
    ...
    server_modules = [
        "servers.fast_cursor_server",
        "servers.fast_windsurf_server",
        "servers.simple_cursor_server",
        "servers.simple_windsurf_server",
        "servers.simple_mcp_server",
        "servers.simplified_mcp_implementation"
    ]
